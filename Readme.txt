Angry Birds Game
This Angry Birds game was created using Java and the libGDX framework. The game has a home page,level selection screen and three levels with different functionality. In addition, the game has a settings tab where you can change numerous in-game parameters.There are also interactive Bird,Pig and Structure components. The goal is to throw birds at structures and pigs, hoping to knock them down and defeat the pigs.
